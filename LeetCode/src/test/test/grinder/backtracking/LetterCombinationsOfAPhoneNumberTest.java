...
class LetterCombinationsOfAPhoneNumberTest {
    ...
    public void testLetterCombinations(){
        String str = "23";
        List<String> listOfStr = LetterCombinationsOfAPhoneNumber.letterCombinations(str);
        getTestResult(listOfStr,listOfResultOfStr23);

        String str2 = "";
        List<String> listOfStr2 = LetterCombinationsOfAPhoneNumber.letterCombinations(str2);
        getTestResult(listOfStr2,listOfResultOfEmptyStr);

        String str3 = "2";
        List<String> listOfStr3 = LetterCombinationsOfAPhoneNumber.letterCombinations(str3);
        getTestResult(listOfStr3,listOfResultOfStr2);

        String str4 = "234";
        List<String> listOfStr4 = LetterCombinationsOfAPhoneNumber.letterCombinations(str4);
