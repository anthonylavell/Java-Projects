...
import disney.MaxiDiffBetweenIncElements;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

class MaxiDiffBetweenIncElementsTest {

    @Test
    void testMaximumDifference() {
        int [] nums = {7,1,5,4};
        int result = 4;
        Assertions.assertEquals(result, MaxiDiffBetweenIncElements.maximumDifference(nums));

        int [] nums2 = {9,4,3,2};
        int result2 = -1;
        Assertions.assertEquals(result2, MaxiDiffBetweenIncElements.maximumDifference(nums2));

        int [] nums3 = {1,5,2,10};
        int result3 = 9;
        Assertions.assertEquals(result3, MaxiDiffBetweenIncElements.maximumDifference(nums3));
        ...
        int[] nums4 = {999,997,980,976,948,940,938,928,924,917,907,907,881,878,864,862,859,
                ...
                48,45,26,26,23,15};
        int result4 = -1;
        Assertions.assertEquals(result4,MaxiDiffBetweenIncElements.maximumDifference(nums4));
